...
var TicketParticipantTableColumns = struct {
	TicketGuildID string
	TicketLocalID string
	UserID        string
	Username      string
	...
	TicketGuildID: "ticket_participants.ticket_guild_id",
	TicketLocalID: "ticket_participants.ticket_local_id",
	UserID:        "ticket_participants.user_id",
	Username:      "ticket_participants.username",
	Discrim:       "ticket_participants.discrim",
	IsStaff:       "ticket_participants.is_staff",
}
...
var (
	...
	ticketParticipantGeneratedColumns      = []string{}
)

type (
	// TicketParticipantSlice is an alias for a slice of pointers to TicketParticipant.
	// This should almost always be used instead of []TicketParticipant.
...
// CountG returns the count of all TicketParticipant records in the query using the global executor
...
func TicketParticipants(mods ...qm.QueryMod) ticketParticipantQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"ticket_participants\".*"})
	}

	return ticketParticipantQuery{q}
}
...
// Exists checks if the TicketParticipant row exists.
func (o *TicketParticipant) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return TicketParticipantExists(ctx, exec, o.TicketGuildID, o.TicketLocalID, o.UserID)
}
